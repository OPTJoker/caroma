...
- (void)configure {
    self.backgroundColor = KRGBCOLOR(214, 215, 216, 1);
}

- (UIImageView *)nowifiImgView {
    if (!_nowifiImgView) {
        _nowifiImgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"refresh"]] ;
...
- (UIButton *)bt {
    if (!_bt) {
        ...
        _bt.showsTouchWhenHighlighted = YES;
